...
#define LV_DEF_REFR_PERIOD  10      /**< [ms] benchmark: lower = higher FPS cap */
 ...
 *  DRM/FBDEV driver buffers are typically 4-8 byte aligned, use 4 to avoid assert */
...
#define LV_DRAW_LAYER_SIMPLE_BUF_SIZE    (48 * 1024)    /**< [bytes] benchmark: larger = fewer chunks */
 ...
 */
#define LV_DRAW_THREAD_STACK_SIZE    (32 * 1024)        /**< [bytes] required for ThorVG */
...
#define LV_FONT_MANAGER_NAME_MAX_LEN            256
